...
public class AutoBlue_4 extends OpMode {
...
//      sets the starting positions of the servos
    ...
    @Override
    public void start() {
//      tells the robot how far to run and at what speed
...
//      makes it so the program can advance the switch statement after moving
        if ( (Math.abs(backLeft.getCurrentPosition() - backLeft.getTargetPosition()) < 5) &&
