...
public class AutoBlue_Final extends OpMode {
...
//      switch statement created for the movements
        switch (step){
            ...
            case(2):moveRobot(34.6,"r");break;
            case(3):moveRobot(117.6,"f");break;
            case(4):moveRobot(134.6,"b");break;
            case(5):moveRobot(145.4,"r");break;
            case(6):moveRobot(175.4, "f");break;
...
//      sets the starting positions of the servos
        climberD.setPosition(climberDPosition);
        button.setPosition(buttonPosition);
        climberR.setPosition(0.78);
        climberRR.setPosition(0.20);
