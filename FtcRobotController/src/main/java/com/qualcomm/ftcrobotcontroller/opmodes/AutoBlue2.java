...
public class AutoBlue2 extends OpMode {
    ...
    final static double button_MIN_RANGE = 0.00;
    final static double button_MAX_RANGE = 1.00;
    ...
    public void init() {
        ...
        climberDPosition = 0.9;
        buttonPosition = 0.45;
        climberRRPosition = 0.78;
        climberRPosition = 0.2;
    ...
    public void loop() {
        ...
        switch (step){
            case(1):moveRobot(1,"f");break;
            case(2):moveRobot(12,"r");break;
            case(3):moveRobot(123,"f");break;
            case(4):moveRobot(23,"b");break;
